...
function LogIn(props: LogInProps) {
    return (
        <Grid2>
       <div style={{ fontSize: '60px', paddingInline: '10vw' , justifyContent: 'flex-start', alignItems: 'center', display: 'flex', flexDirection: 'column', color: '#6c9482', fontFamily:  'agrandir-reg' }}>
